...
function ExpenseHistoryTransaction() {
    ...
    function checkingHistory() {
        async function getHistory() {
            try {
                ...
                let history = await contract.methods.expenseHistory(details).call();
    ...
    return (
        <div>
            ...
            <button onClick={()=>{if (details !== "") {
            checkingHistory()
        }
        else alert("please enter expense detail")
    }
        }>
                Get Expense History
            </button>
...
export default ExpenseHistoryTransaction;